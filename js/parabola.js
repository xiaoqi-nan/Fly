    ...
    Parabola.prototype = {
        ...
        initialize: function (options) {
            ...
            if (ops.targetEl) {
                ...
                this.driftX = toInteger(_$(ops.targetEl).css("left")) - this.elOriginalLeft - driftx;
                this.driftY = toInteger(_$(ops.targetEl).css("top")) - this.elOriginalTop + drifty;
                //ccc = (this.driftY - ops.curvature * this.driftX * this.driftX) / this.driftX;
                //x2 = extend;
                //this.driftX = this.driftX + x2;
                //this.driftY = ops.curvature * this.driftX * this.driftX + ccc * this.driftX;
